...
input_pretty "Please enter which SAP Software installation media to download (options are sap_s4hana_2021, sap_s4hana_2020)" ANSIBLE_SAP_DOWNLOADS_SELECTED
